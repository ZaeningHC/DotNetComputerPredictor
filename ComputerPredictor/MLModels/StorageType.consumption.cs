...
namespace ComputerPredictor
{
    ...
    {
        /// <summary>
        /// model input class for StorageType.
        /// </summary>
        ...
        /// <summary>
        /// model output class for StorageType.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"storage_type")]
            public uint Storage_type { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath(Path.Combine("MLModels", "StorageType.mlnet"));
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("storage_type");
            if (labelColumn == null)
            {
                throw new Exception("storage_type column not found. Make sure the name searched for matches the name in the schema.");
            }

...
namespace ComputerPredictor
{
    public partial class RamGb
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath(Path.Combine("MLModels", "RamGb.mlnet"));
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("ram_gb");
            if (labelColumn == null)
            {
                throw new Exception("ram_gb column not found. Make sure the name searched for matches the name in the schema.");
            }

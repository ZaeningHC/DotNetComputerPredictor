...
namespace ComputerPredictor
{
    ...
    {
        /// <summary>
        /// model input class for StorageGb.
        /// </summary>
        ...
        /// <summary>
        /// model output class for StorageGb.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"storage_gb")]
            public uint Storage_gb { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath(Path.Combine("MLModels", "StorageGb.mlnet"));
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("storage_gb");
            if (labelColumn == null)
            {
                throw new Exception("storage_gb column not found. Make sure the name searched for matches the name in the schema.");
            }

...
namespace ComputerPredictor
{
    ...
    {
        /// <summary>
        /// model input class for TargetUseCase.
        /// </summary>
        ...
        /// <summary>
        /// model output class for TargetUseCase.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"target_use_case")]
            public uint Target_use_case { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath(Path.Combine("MLModels", "TargetUseCase.mlnet"));
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("target_use_case");
            if (labelColumn == null)
            {
                throw new Exception("target_use_case column not found. Make sure the name searched for matches the name in the schema.");
            }

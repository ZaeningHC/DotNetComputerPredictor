...
namespace ComputerPredictor
{
    ...
    {
        /// <summary>
        /// model input class for CpuCores.
        /// </summary>
        ...
        /// <summary>
        /// model output class for CpuCores.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath(Path.Combine("MLModels", "CpuCores.mlnet"));
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("cpu_cores");
            if (labelColumn == null)
            {
                throw new Exception("cpu_cores column not found. Make sure the name searched for matches the name in the schema.");
            }

...
namespace ComputerPredictor
{
    public partial class OperatingSystem
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"storage_type", @"storage_type"),new InputOutputColumnPair(@"target_use_case", @"target_use_case")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
